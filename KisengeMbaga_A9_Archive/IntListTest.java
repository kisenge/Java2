...
public class IntListTest {
	...
	public static void dispatch(int choice) {
		...
		switch (choice) {
			...
			case 4: //print
				 ...
				 break;
			case 5: //length
				 System.out.print("The list length is " + list.length());
				 break;
			case 6: //remove length
				 list.removeLast();
				 break;
			case 7: //print recursively
				 list.printRec();
				 break;
			case 8: //print recurisvely  in reverse
				 list.printRecRev();
				 break;
	...
	public static void printMenu() {
		...
		System.out.println("5: Print the length");
		System.out.println("6: Remove last");
		System.out.println("7: Recursive Print");
		System.out.println("8: Recursive Reverse Print");
